    ...
    // echo "<a href='/matrimonial-signup/'>Signup</a>";
       ...
       ?>
        ...
        <div class="cstm-form">
            ...
            <label class="all-field-lable">Email</label><input type="email" name="email" placeholder="Enter your email"/>
            <br><label class="all-field-lable">Phone Number</label><input type="number" name="number" placeholder="Enter your Phonenumber"/>
            <br><label class="all-field-lable">Username</label><input type="text" name="username" placeholder="Choose username"/>
            <br><label class="all-field-lable">Password</label><input type="password" name="password_custom" placeholder="Create password"/>
            <br><label class="all-field-lable">Payment Screenshot</label><input type="file" name="payment_proof" class="payment_proof" placeholder="Payment Screenshot">
...
<div class="wrapper">
  <div class="profiles-wrapper">
	...
	?>
      <h3 class="name"><?php $current_user->user_login; ?> </h3>
		</div>
      <div class="email"><b>Email:</b>&nbsp;<?php echo $current_user->user_email; ?></div>
    </div>
    ...
    <form class="post_upload">
      <div class="formbold-mb-5">
        ...
        <input
          ...
          name="post_title"
          id="post_title"
          placeholder="ਪੋਸਟ ਦਾ ਸਿਰਲੇਖ ਲਿਖੋ"
